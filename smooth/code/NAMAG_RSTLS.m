function [x_APB,y_APB,val_all,rlerr_all]=NAMAG_RSTLS(P,Xor,Xcon,B,center,sigma_w,sigma_e,N,pars,s,r)
...
while iter<N
    ...
    % sigma=2*min(min(abs(DC).^2))+(sigma_w^2)*(pars.lambda)*2;
    % kappa=L/sigma; % condition number
