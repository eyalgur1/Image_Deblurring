function [prox_sol,i]=tv_l1(X,lam,t,N)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
while((i<N)&(count<5))
    ...
    D=project(X-(lambda/2)*Lforward(R));
    Q=Ltrans(D);

    % Taking a step towards minus of the gradient
    P{1}=R{1}+1/(16*lambda)*Q{1};
    P{2}=R{2}+1/(16*lambda)*Q{2};
    ...
    fval=norm(project(X-(lambda/2)*Lforward(P)),'fro')^2;
